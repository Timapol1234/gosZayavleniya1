...
export const metadata: Metadata = {
  ...
  keywords:
    'заявление онлайн, конструктор заявлений, создать заявление, образец заявления, шаблоны заявлений бесплатно, готовые заявления, бланки документов, МФЦ, суд, банк, налоговая, конструктор документов, юридические документы онлайн, заявление скачать, как написать заявление',
